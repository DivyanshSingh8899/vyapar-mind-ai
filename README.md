# Vyapar-Mind — AI Business Operator for Indian Merchants
...
The merchant doesn't open a dashboard. The merchant **speaks**, and the agent understands the intent, calls the right business tool against the database, and answers back in the merchant's language — while payment announcements always take priority over any conversation.
